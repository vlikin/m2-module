    ...
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function getPost()
    {
        ...
        if (!$this->hasData('post')) {
            if ($this->getPostId()) {
                /** @var \Vlikin\Blog\Model\Post $page */
    ...
    {
        return [\Vlikin\Blog\Model\Post::CACHE_TAG . '_' . $this->getPost()->getId()];
    }
